...
router.post('/reg_kafic', async(req, res) => {
    try {
        ...
        let sql = `call kafic_insert('${kafic_naziv}', '${kafic_email}', '${kafic_sifra}', '${kafic_adresa}', '${grad}', '${drzava}', '${kapacitet}', '${slobodna_mesta}', '${radno_vreme }', '${kafic_opis}')`
        //let sql = `INSERT INTO kafici  (kafic_naziv, kafic_email, kafic_sifra, kafic_adresa, grad, drzava, kapacitet,slobodna_mesta, radno_vreme, kafic_opis)  VALUES ('${kafic_naziv}', '${kafic_email}', '${kafic_sifra}', '${kafic_adresa}', '${grad}', '${drzava}', '${kapacitet}', '${slobodna_mesta}', '${radno_vreme }', '${kafic_opis}')`
